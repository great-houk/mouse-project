...
pub type SPI2_CLK_SCALE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `spi2_clk_scale` writer - Control Settings for CLK13 - SPI Master 2"]
pub type SPI2_CLK_SCALE_W<'a> =
    crate::FieldWriter<'a, u32, SYS_CLK_CTRL_13_SPI2_SPEC, u8, u8, 4, 0>;
impl R {
