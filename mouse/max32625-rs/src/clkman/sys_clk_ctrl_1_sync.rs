...
pub type SYNC_CLK_SCALE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `sync_clk_scale` writer - Control Settings for CLK1 - Synchronizer Clock"]
pub type SYNC_CLK_SCALE_W<'a> = crate::FieldWriter<'a, u32, SYS_CLK_CTRL_1_SYNC_SPEC, u8, u8, 4, 0>;
impl R {
