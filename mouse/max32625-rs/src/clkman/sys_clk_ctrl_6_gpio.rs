...
pub type GPIO_CLK_SCALE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `gpio_clk_scale` writer - Control Settings for CLK6 - Clock for GPIO Ports"]
pub type GPIO_CLK_SCALE_W<'a> = crate::FieldWriter<'a, u32, SYS_CLK_CTRL_6_GPIO_SPEC, u8, u8, 4, 0>;
impl R {
