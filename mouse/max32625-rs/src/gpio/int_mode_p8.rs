...
pub type PIN0_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 0>;
...
pub type PIN1_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 4>;
...
pub type PIN2_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 8>;
...
pub type PIN3_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 12>;
...
pub type PIN4_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 16>;
...
pub type PIN5_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 20>;
...
pub type PIN6_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 24>;
...
pub type PIN7_W<'a> = crate::FieldWriter<'a, u32, INT_MODE_P8_SPEC, u8, u8, 3, 28>;
impl R {
