...
pub type CORE_IO_REQ_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 4>;
...
I/O Request"]
pub type SS0_IO_REQ_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 8>;
...
I/O Request"]
pub type SS1_IO_REQ_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 9>;
...
I/O Request"]
pub type SS2_IO_REQ_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 10>;
#[doc = "Field `ss3_io_req` reader - SPI Master 0 SS\\[3\\]
I/O Request"]
pub type SS3_IO_REQ_R = crate::BitReader<bool>;
#[doc = "Field `ss3_io_req` writer - SPI Master 0 SS\\[3\\]
I/O Request"]
pub type SS3_IO_REQ_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 11>;
#[doc = "Field `ss4_io_req` reader - SPI Master 0 SS\\[4\\]
I/O Request"]
pub type SS4_IO_REQ_R = crate::BitReader<bool>;
#[doc = "Field `ss4_io_req` writer - SPI Master 0 SS\\[4\\]
I/O Request"]
pub type SS4_IO_REQ_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 12>;
...
pub type QUAD_IO_REQ_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 20>;
...
pub type FAST_MODE_W<'a> = crate::BitWriter<'a, u32, SPI0_REQ_SPEC, bool, 24>;
impl R {
...
I/O Request"]
    ...
    pub fn ss3_io_req(&mut self) -> SS3_IO_REQ_W {
        SS3_IO_REQ_W::new(self)
    }
    #[doc = "Bit 12 - SPI Master 0 SS\\[4\\]
I/O Request"]
    #[inline(always)]
    pub fn ss4_io_req(&mut self) -> SS4_IO_REQ_W {
        SS4_IO_REQ_W::new(self)
    }
    #[doc = "Bit 20 - SPI Master 0 Quad I/O Request"]
    #[inline(always)]
