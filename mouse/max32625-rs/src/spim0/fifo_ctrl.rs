...
pub type TX_FIFO_AE_LVL_W<'a> = crate::FieldWriter<'a, u32, FIFO_CTRL_SPEC, u8, u8, 4, 0>;
...
pub type RX_FIFO_AF_LVL_W<'a> = crate::FieldWriter<'a, u32, FIFO_CTRL_SPEC, u8, u8, 5, 16>;
